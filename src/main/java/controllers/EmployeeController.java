...
public class EmployeeController extends HttpServlet {
    ...
    private void addEmployee(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Employee newEmployee = new Employee(id, name, email, phone, department, position);
        employeeService.addEmployee(newEmployee);

        response.sendRedirect(request.getContextPath() + "/employees");
    }

        //System.out.println("Adding employee: " + name + ", " + email + ", " + phone + ", " + department + ", " + position);

        //Employee newEmployee = new Employee(name, email, phone, department, position);
        //employeeService.addEmployee(newEmployee);

        // For debugging purposes, print the list of employees after addition
        //List<Employee> updatedEmployees = employeeService.getAllEmployees();
        //System.out.println("Employees after addition: " + updatedEmployees);
